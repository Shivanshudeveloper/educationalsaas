...
const List = () => {
  ...
  const editClass = async () => {
    await axios
      .patch(`${API_SERVICE}/edittraininglist`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getClass();
        handleClose();
        setFormData(initialState);
  ...
  const addClass = async () => {
    await axios
      .post(`${API_SERVICE}/addtraininglist`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getClass();
        handleClose();
        setFormData(initialState);
  ...
  const getClass = async () => {
    await axios
      .get(`${API_SERVICE}/gettraininglist/${userEmail}`)
