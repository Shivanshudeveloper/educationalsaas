...
const List = () => {
  ...
  const editTeacher = async () => {
    await axios
      .patch(`${API_SERVICE}/editteacherlist`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getTeachers();
        handleClose();
        setFormData(initialState);
  ...
  const addTeacher = async () => {
    await axios
      .post(`${API_SERVICE}/addteacherlist`,  {formData:formData,userEmail:userEmail})
      .then((res) => {
        getTeachers();
        handleClose();
        setFormData(initialState);
  ...
  const getTeachers = async () => {
    await axios
      .get(`${API_SERVICE}/getteacherlist/${userEmail}`)
