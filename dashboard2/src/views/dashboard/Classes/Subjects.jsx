...
const List = () => {
  ...
  const editSubject = async () => {
    await axios
      .patch(`${API_SERVICE}/editclasssubject`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getSubject();
        handleClose();
        setFormData(initialState);
  ...
  const addSubject = async () => {
    await axios
      .post(`${API_SERVICE}/addclasssubject`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getSubject();
        handleClose();
        setFormData(initialState);
  ...
  const getSubject = async () => {
    await axios
      .get(`${API_SERVICE}/getclasssubject/${userEmail}`)
