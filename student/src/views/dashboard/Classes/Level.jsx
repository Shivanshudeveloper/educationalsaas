...
const Level = () => {
  ...
  const editSubject = async () => {
    await axios
      .patch(`${API_SERVICE}/editclasslevel`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getSubject();
        handleClose();
        setFormData(initialState);
  ...
  const addSubject = async () => {
    await axios
      .post(`${API_SERVICE}/addclasslevel`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getSubject();
        handleClose();
        setFormData(initialState);
  ...
  const getSubject = async () => {
    await axios
      .get(`${API_SERVICE}/getclasslevel/${userEmail}`)
      .then((res) => {
