...
const List = () => {
  ...
  const editClass = async () => {
    await axios
      .patch(`${API_SERVICE}/editobserver`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getClass();
        handleClose();
        setFormData(initialState);
  ...
  const addClass = async () => {
    await axios
      .post(`${API_SERVICE}/addobserver`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getClass();
        handleClose();
        setFormData(initialState);
  ...
  const getClass = async () => {
    await axios
      .get(`${API_SERVICE}/getobserver/${userEmail}`)
      .then((res) =>{
  ...
  return (
    <div>
      ...
      <Container sx={{ mt: 2 }} maxWidth="lg">
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end",mr:5,height:"40px"}}>
