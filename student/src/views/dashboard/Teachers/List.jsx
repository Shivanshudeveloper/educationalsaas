...
const List = () => {
  ...
  const editTeacher = async () => {
    await axios
      .patch(`${TEST_API_SERVICE}/editteacherlist`, {formData:formData,userEmail:userEmail})
      .then((res) => {
        getTeachers();
        handleClose();
        setFormData(initialState);
  ...
  const addTeacher = async () => {
    auth
      .createUserWithEmailAndPassword(formData.Email, default_password)
      .then(async (userCredential) => {
        await axios
          .post(`${TEST_API_SERVICE}/addteacherlist`,  {formData:formData,userEmail:userEmail})
          .then((res) => {
            getTeachers();
            handleClose();
            setFormData(initialState);
  ...
  const getTeachers = async () => {
    await axios
      .get(`${TEST_API_SERVICE}/getteacherlist/${userEmail}`)
  ...
  const getClass = async () => {
    await axios
      .get(`${TEST_API_SERVICE}/getclasslist/${userEmail}`)
  ...
  const deleteRow = async (id) => {
    await axios
      .delete(`${TEST_API_SERVICE}/deleteteacher/${id}`)
